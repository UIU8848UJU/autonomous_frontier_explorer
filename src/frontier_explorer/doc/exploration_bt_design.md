...
```text
lib/frontier_explorer/libfrontier_explorer_bt_nodes.so
```
...
exploration_bt_orchestrator_node:
  ros__parameters:
    ...
    bt_plugin_libraries:
      - /home/xxx/mk_nav2/install/frontier_explorer/lib/frontier_explorer/libfrontier_explorer_bt_nodes.so
    tick_period_sec: 0.1
