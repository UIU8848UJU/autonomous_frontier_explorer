    ...
    std::size_t max_candidates)
{
    ...
    const auto frontier_cells = detector_.detect_frontier_cells(map_costmap_.gridMap());
    const auto clusters = detector_.cluster_frontiers(map_costmap_.gridMap(), frontier_cells);
