...
: config_(std::move(config)),
  ranker_(ranker ? std::move(ranker) : std::make_shared<RuleBasedFrontierRanker>(
      std::move(scoring_weights), config_.max_retry_count))
{
}

void FrontierSelectionPolicy::reset()
{
    state_ = FrontierSelectionState{};
